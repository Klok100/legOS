...
/* Set to 1 to run all test cases */
#define RUN_TESTS 0

/* Set to 1 if we want to enable our RTC,    */
/* and for Checkpoint 3.1, run the testcase! */
/* Ignore for now, already tests in launch_tests() */
#define ENABLE_RTC 1

/* Set to 1 if we want to run "shell".  */
...
void entry(unsigned long magic, unsigned long addr) {
    ...
    fileSystem_init(file_system_start_addr);
    ...
    /* Run tests */
    launch_tests();
    printf("\nTests launched and finished! Proceeding to spin...\n");
#endif
